...
export JARS="--jars /GITHUB/claerity-cloudera/XWARE42/shop-crawl/out/artifacts/any23_extractor_tool_jar/any23-extractor-tool.jar,/GITHUB/SparkShellUtilities/out/artifacts/s2u_jar/s2u.jar,/sparkws/bin/gephi-toolkit-0.9.2-20170113.202843-77-all.jar,/GITHUB/cuda-tsa/bin/all.jar"
